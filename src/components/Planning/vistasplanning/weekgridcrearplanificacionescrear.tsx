...
interface WeekGridCrearPlanificacionesProps {
  weekDays: WeekDay[];
...
const WeekGridCrearPlanificaciones: React.FC<WeekGridCrearPlanificacionesProps> = ({
  weekDays,
  selectedWeeks,
  onWeekSelect,
  selectionStart,
    ...
    <div className="bg-white p-6 rounded-xl shadow-md border border-indigo-100">
      ...
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Add Week Button - Added type="button" and updated onClick handler */}
...
export default WeekGridCrearPlanificaciones;