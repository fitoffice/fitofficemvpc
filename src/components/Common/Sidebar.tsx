...
const Sidebar: React.FC = () => {
  ...
  const navItems = [
    ...
    { to: '/routines', icon: Dumbbell, label: 'Entrenamiento', visible: false },
    { to: '/diets', icon: Salad, label: 'Dietas', visible: false },
    { to: '/classes', icon: BookOpen, label: 'Clases', visible: true },
    { to: '/economics', icon: DollarSign, label: 'Finanzas', visible: true },
